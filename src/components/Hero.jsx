...
import heroImg from '../images/service 1.png';
            ...
            <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                    <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                        <h1 className="mb-5 md:text-5xl text-3xl font-bold text-red-700">
                            Pumping Solutions for Operational Excellence
                        </h1>
                        <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">
                            Our Team of Experts is Committed to Your Pump System's Success.
                        </div>
                        <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                            {/* 
                            <Link to="/contact" className="text-white bg-red-900 hover:bg-red-700 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0">
                                Contact Us
